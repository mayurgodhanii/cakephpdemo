...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<?php echo $this->Form->create('User', array('role' => 'form', 'url' => array('action' => 'forgot_password'))); ?>
                    ...
                    <div class="form-group">
                        ...
                        <?php echo $this->Form->input('User.email', array('label' => false, 'placeholder' => "Example: abc@abc.com", 'class' => "form-control")); ?>
