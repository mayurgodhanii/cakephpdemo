	...
	<div class="container">
		...
		<div class=" contact-w3">	
			<div class="col-md-5 contact-right">	
				<img src="<?php echo $this->webroot;?>img/cac.jpg" class="img-responsive" alt="">
...
<script src="<?php echo $this->webroot;?>js/easyResponsiveTabs.js" type="text/javascript"></script>
	<script type="text/javascript">
		$(document).ready(function () {
