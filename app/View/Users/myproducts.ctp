<!-- <div class="kic-top ">
	...
	<div class="kic ">
		...
		<div class="col-md-4 kic-top1">
			<a href="single.html">
				<img src="<?php echo $this->webroot;?>img/ki.jpg" class="img-responsive" alt="">
			</a>
			<h6>Dal</h6>
		...
		<div class="col-md-4 kic-top1">
			<a href="single.html">
				<img src="<?php echo $this->webroot;?>img/ki1.jpg" class="img-responsive" alt="">
			</a>
			<h6>Snacks</h6>
			<p>Nam libero tempore</p>
		</div>
		<div class="col-md-4 kic-top1">
			<a href="single.html">
				<img src="<?php echo $this->webroot;?>img/ki2.jpg" class="img-responsive" alt="">
			</a>
			<h6>Spice</h6>
			<p>Nam libero tempore</p>
		</div>
